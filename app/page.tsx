...
import { Hero, StatsDisplay, Work, Skills, Projects, Contact, SocialMedia, Recents, Certifications } from '@/app/sections';
  ...
  return (
    ...
    <div className={`flexCenter bg-StrongYellowBg dark:bg-zinc-900`}>
      <div className={`paddingX flexCenter`}>
        <div className="boxWidth">
          <Footer />
          <div className={`flexCenter py-6 text-PurpleTheme font-poppins font-semibold flex-wrap`}>Made with 💖 by Om Patel</div>
        </div>
      </div>
    </div>
  </div>
